...
def mock_valid_benchmark_data():
    return {
        ...
        'design': {
            'tested_capability_definition': {'score': 10, 'justification': 'Clear definition.'},
            ...
            'differences_to_related_benchmarks': {'score': 10, 'justification': 'Done.'}
        },
        'implementation': {
        ...
        'documentation': {
            ...
            'normative_properties_documented': {'score': 5, 'justification': 'Briefly.'},
            ...
            'data_representativeness_explained': {'score': 5, 'justification': 'Partial.'},
...
def mock_invalid_benchmark_data():
    return {
        ...
        'design': {
            'tested_capability_definition': {'score': 99, 'justification': 'Invalid score.'}
        },
        'implementation': {
            'evaluation_code_available': {'score': 15} 
        },
        'documentation': {
            'inline_code_comments': {'score': 5, 'justification': ''}
        }
    }